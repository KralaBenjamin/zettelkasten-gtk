...
class ZettelkastenFlatpakApplication(Adw.Application):
    ...
    def __init__(self):
        super().__init__(application_id='com.github.kralabenjamin.zettelkasten',
    ...
    def on_about_action(self, *args):
        ...
        about = Adw.AboutDialog(application_name='zettelkasten-flatpak',
                                application_icon='com.github.kralabenjamin.zettelkasten',
                                developer_name='snowparrot',
                                version='0.1.0',
                                developers=['snowparrot'],
                                copyright='© 2025 snowparrot')
